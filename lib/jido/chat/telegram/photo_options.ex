defmodule Jido.Chat.Telegram.PhotoOptions do
  @moduledoc """
  ...
  @doc "Returns the Zoi schema for photo options."
  def schema, do: @schema

  @doc "Builds typed photo options from keyword/map/struct input."
  ...
  @doc "Builds Telegram API payload options for `sendPhoto`."
