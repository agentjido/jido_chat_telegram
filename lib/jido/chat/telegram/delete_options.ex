defmodule Jido.Chat.Telegram.DeleteOptions do
  @moduledoc """
  Typed options for Telegram `delete_message/3`.
  """
  ...
  @doc "Builds typed delete options from keyword, map, or struct input."
